...
var AppController = (function () {
    function AppController(model) {
        ...
        this.messageDs.on("push", function () {
            _this.fetchMessage();
        });
        this.memoDs.on("push", function () {
            _this.fetchMemo();
        });
        this.memoDs.on("set", function () {
            _this.fetchMemo();
        });
    }

    _prototypeProperties(AppController, null, {
        sendMessage: {
            value: function sendMessage(user, text) {
        ...
        fetchMessage: {
            value: function fetchMessage() {
                ...
                this.messageDs.query().sort("desc").limit(100).done(function (data) {
                    _this.appModel.messages = data;
                });
            },
            writable: true,
            configurable: true
        ...
        fetchMemo: {
            value: function fetchMemo() {
                var _this = this;

                this.memoDs.query().sort("desc").limit(1000).done(function (data) {
                    //カテゴリ生成
                    //var categoryTree = createCategoryTree(data);
                    //TODO カテゴリ表示
                    //TODO 現在選択中カテゴリを元に絞込

                    _this.appModel.memos = data;
                });
            },
            writable: true,
            configurable: true
        ...
        updateMemo: {
            value: function updateMemo(memo, callback) {
        ...
        removeMemo: {
            value: function removeMemo(id, callback) {
        ...
        editMemo: {
            value: function editMemo(id, callback) {
...
var AppController = _interopRequire(require("./appController.js"));
...
new Vue({
    ...
    methods: {
        ...
        updateMemo: function updateMemo(memo) {
            var _this = this;

            appController.updateMemo(memo, function () {
                _this.onEndEditing();
            });
        },
        removeMemo: function removeMemo(id) {
            var _this = this;

            appController.removeMemo(id, function () {
                _this.render();
            });
        },
        editMemo: function editMemo(id) {
            ...
            appController.editMemo(id, function (data) {
                _this.isEditing = true;
                _this.memo.text = data.text;
                _this.memo.id = id;
            });
        }
    },
